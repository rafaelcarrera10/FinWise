...
public class InvestmentAccountController {
    ...
    public List<InvestmentAccountModel> getByActionName(@RequestBody String actionName) {
    ...
    public boolean existsByActionName(@RequestBody String actionName) {
    ...
    public List<InvestmentAccountModel> getByValueGreaterThan(@RequestBody BigDecimal minValue) {
    ...
    public List<InvestmentAccountModel> getByValueLessThan(@RequestBody BigDecimal maxValue) {
        return service.findByValueLessThan(maxValue);
    }

    // Buscar investimentos com valor entre dois valores
    @GetMapping("/value-between")
    public List<InvestmentAccountModel> getByValueBetween(@RequestBody BigDecimal minValue, @RequestBody BigDecimal maxValue) {
    ...
    public List<InvestmentAccountModel> getByQuantityGreaterThan(@RequestBody Integer minQuantity) {
    ...
    public List<InvestmentAccountModel> getByQuantityLessThan(@RequestBody Integer maxQuantity) {
    ...
    public List<InvestmentAccountModel> getByQuantityBetween(@RequestBody Integer minQuantity, @RequestBody Integer maxQuantity) {
    ...
    public List<InvestmentAccountModel> getPaginated(@RequestBody Integer page, @RequestBody Integer size) {
    ...
    public InvestmentAccountModel updateInvestmentValue(@RequestBody Long id, @RequestBody BigDecimal newValue) {
    ...
    public InvestmentAccountModel updateInvestmentQuantity(@RequestBody Long id, @RequestBody Integer newQuantity) {
    ...
    public InvestmentAccountModel updateInvestmentActionName(@RequestBody Long id, @RequestBody String newActionName) {
    ...
    public InvestmentAccountModel addToInvestmentQuantity(@RequestBody Long id, @RequestBody Integer amount) {
    ...
    public InvestmentAccountModel subtractFromInvestmentQuantity(@RequestBody Long id, @RequestBody Integer amount) {
    ...
    public int deleteByActionName(@RequestBody String actionName) {
        return service.deleteByActionName(actionName);
    }

    // Calcula o valor total investido por usuário
    @GetMapping("/total-value-by-user") 
    public BigDecimal getTotalInvestmentValueByUserId(@RequestBody Long userId) {
    ...
    public Integer getTotalQuantityByUserId(@RequestBody Long userId) {
    ...
    public BigDecimal getMaxValueByUserId(@RequestBody Long userId) {
    ...
    public BigDecimal getMinValueByUserId(@RequestBody Long userId) {
    ...
    public Integer getMaxQuantityByUserId(@RequestBody Long userId) {
    ...
    public Integer getMinQuantityByUserId(@RequestBody Long userId) {

...
public class ContaInvestimentoService {
    ...
    @Autowired
    public ContaInvestimentoService(InvestmentAccountRepository repository) {
    ...
    // Buscar todas as contas de um usuário específico
    public List<InvestmentAccountModel> findByUserId(Integer userId) {
        return repository.findByUsuario_Id(userId);
    }
}
